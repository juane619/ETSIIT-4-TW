 ...
 * 
 * Es posible crear vistas especificando el nombre de la vista y el 
 * subdirectorio (por cada vista creada) dentro del directorio principal 
 * comun a todas las vistas (variable estática).
 */
...
class View extends Response
{
     ...
     */
    public function __construct($view, $subdir)
    {
        $this->subdir = $subdir.'/';
        $this->view = $view;
        $this->attrs = [];
    ...
    public function get()
    {
        ...
        include ROOT_PATH . self::$dir . $this->subdir . self::$suf . $this->view . self::$ext;
     ...
     */
    static function make($view, $subdir=null)
    {
        return new self($view, $subdir);
    }
    /**
    ...
    /**
     * Establece el prefijo de las plantillas (por defecto _templ).
     *
     * @param String $suf Sufijo de las plantillas.
     */
    static function set_suf($suf)
    {
        self::$suf = $suf;
    }

    /**
     * Establece el prefijo de las plantillas (por defecto .php).
     *

    ...
    if($_SESSION['user_type'] == 0) {
        echo <<< HTML
            ...
            <div class="col-75">
                <select name="tipo">
HTML;
                    echo '<option value="1" '. ($user->getTipo() == 1 ?"selected":"") .'>Colaborador</option>';
                    echo '<option value="0" '. ($user->getTipo() == 0 ?"selected":"") .'>Administrador</option>';
                echo <<< HTML
                </select>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-75">
                <select name="estado">
HTML;
                    echo '<option value="activo" '. ($user->getEstado() == 'activo' ?"selected":"") .'>Activo</option>';
                    echo '<option value="inactivo" '. ($user->getEstado() == 'inactivo' ?"selected":"") .'>Inactivo</option>';
                echo <<< HTML
                </select>
            </div>
        </div>
